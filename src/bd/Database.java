...
public class Database {
	...
	public static Connection getMySQLConnection() throws SQLException {
		...
		if(!DBStatic.pooling) {
			...
			return DriverManager.getConnection("jdbc:mysql://"+DBStatic.mysql_host+":"+DBStatic.mysql_port+"/"+DBStatic.mysql_db+"?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", DBStatic.mysql_user, DBStatic.mysql_password);
